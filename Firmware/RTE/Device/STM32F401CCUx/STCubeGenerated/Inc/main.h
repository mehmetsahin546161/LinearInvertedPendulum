...
#define MOTOR_DIR_B_GPIO_Port GPIOA
#define MOTOR_ENCODER_B_Pin GPIO_PIN_6
#define MOTOR_ENCODER_B_GPIO_Port GPIOA
#define MOTOR_ENCODER_A_Pin GPIO_PIN_7
#define MOTOR_ENCODER_A_GPIO_Port GPIOA
#define PENDULUM_ENCODER_A_Pin GPIO_PIN_8
#define PENDULUM_ENCODER_A_GPIO_Port GPIOA
#define PENDULUM_ENCODER_B_Pin GPIO_PIN_9
#define PENDULUM_ENCODER_B_GPIO_Port GPIOA
#define UART_DEBUG_TX_Pin GPIO_PIN_11
#define UART_DEBUG_TX_GPIO_Port GPIOA
#define UART_DEBUG_RX_Pin GPIO_PIN_12
